...
UNREALROOTPATH = /home/timl/Dev/UnrealEngine
GAMEPROJECTFILE =/home/timl/Documents/Unreal Projects/FilesystemTest/FilesystemTest.uproject
...
TARGETS = \
	...
	UE4Server \
	FilesystemTest-Linux-Debug  \
	FilesystemTest-Linux-DebugGame  \
	FilesystemTest-Linux-Shipping  \
	FilesystemTest-Linux-Test  \
	FilesystemTest \
	FilesystemTestEditor-Linux-Debug  \
	FilesystemTestEditor-Linux-DebugGame  \
	FilesystemTestEditor-Linux-Shipping  \
	FilesystemTestEditor-Linux-Test  \
	FilesystemTestEditor\
	configure
...
FilesystemTest-Linux-Debug:
	 $(PROJECTBUILD) FilesystemTest Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTest-Linux-DebugGame:
	 $(PROJECTBUILD) FilesystemTest Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTest-Linux-Shipping:
	 $(PROJECTBUILD) FilesystemTest Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTest-Linux-Test:
	 $(PROJECTBUILD) FilesystemTest Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTest:
	 $(PROJECTBUILD) FilesystemTest Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTestEditor-Linux-Debug:
	 $(PROJECTBUILD) FilesystemTestEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTestEditor-Linux-DebugGame:
	 $(PROJECTBUILD) FilesystemTestEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTestEditor-Linux-Shipping:
	 $(PROJECTBUILD) FilesystemTestEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTestEditor-Linux-Test:
	 $(PROJECTBUILD) FilesystemTestEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

FilesystemTestEditor:
	 $(PROJECTBUILD) FilesystemTestEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
